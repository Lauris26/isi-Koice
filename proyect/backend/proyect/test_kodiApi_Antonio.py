...
class TestKodiApi(unittest.TestCase):
    ...
    def test_kodi_obtenerToken(self):
        library=self.my_kodi.obtenerToken()
        print(library)
        primer_elemento = list(library)[0]
        print(primer_elemento)
        self.assertNotEqual(primer_elemento, 'error', "Should be not None")
    ...
    def test_kodi_addPortada(self):
        library=self.my_kodi.addPortada(1)
        print(library)
        primer_elemento = list(library)[0]
        print(primer_elemento)
        self.assertNotEqual(primer_elemento, 'error', "Should be not None")

    def test_kodi_addPortadaSerie(self):
        library=self.my_kodi.addPortadaSerie(1)
        print(library)
        primer_elemento = list(library)[0]
        print(primer_elemento)
        self.assertNotEqual(primer_elemento, 'error', "Should be not None")

    def test_kodi_addActores(self):
        library=self.my_kodi.addActores(1)
        print(library)
        primer_elemento = list(library)[0]
        print(primer_elemento)
        self.assertNotEqual(primer_elemento, 'error', "Should be not None")

    def test_kodi_addActoresSerie(self):
        library=self.my_kodi.addActoresSerie(1)
        print(library)
        primer_elemento = list(library)[0]
        print(primer_elemento)
        self.assertNotEqual(primer_elemento, 'error', "Should be not None")
